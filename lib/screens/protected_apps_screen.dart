...
class _ProtectedAppsScreenState extends ConsumerState<ProtectedAppsScreen> {
  ...
  Future<void> _handleContinue() async {
    ...
    // speak(), not speakWithLipSync() -- see intro_screens.dart's HelloScreen
    // for why: this screen has no VanyaTalkingCharacter to play back the
    // synthesized file, so speakWithLipSync's audio was never actually heard.
